<template>
	<div class="cl-editor-quill">
		...
		<cl-upload-space ref="upload-space" :show-button="false" @confirm="onUploadSpaceConfirm">
		</cl-upload-space>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		onUploadSpaceConfirm(urls) {
			if (urls) {
				urls.split(",").forEach((url, i) => {
					this.quill.insertEmbed(this.cursorIndex + i, "image", url, Quill.sources.USER);
				});
			}
		},
